...
async function writeData(type, path, data) {
    ...
    const isExistsFile = fs_1.default.existsSync((0, exports.typeMapping)(config)[type].writePath);
    if (!isExistsFile)
        (0, utils_1.mkdirsSync)((0, exports.typeMapping)(config)[type].writePath);
...
const typeMapping = (config) => {
    return {
        params: {
            ...
            writePath: path_1.default.resolve(process.cwd(), config.generateFormPath),
        },
        response: {
