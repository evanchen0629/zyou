...
async function generateAll() {
    ...
    process.on('exit', function () {
        ...
        console.log(`The source code is at ${colors_1.default.green('https://github.com/evanchen0629/zyou')}. If you have any questions, please ask in issue, or you can email me at ${colors_1.default.green('cczapp@163.com')}`);
    });
}
